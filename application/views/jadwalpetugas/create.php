        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    ?>
                    <form method="post" class="forms-sample " action="<?php echo base_url(); ?>jadwalpetugas/save">
                        ...
                        <div class="form-group">
                            ...
                            <select name="JadwalPetugasPetugasId" class="form-control" required>
                                ...
                                <?php foreach($petugas as $row){ ?>
                                    <option value="<?= $row->PetugasId; ?>"><?= $row->PetugasNama; ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="JadwalPetugasJadwalId" class="form-control" required>
                                ...
                                <?php foreach($jadwal as $row){ ?>
                                    <option value="<?= $row->JadwalId; ?>"><?= $row->JadwalTanggalMulai." Sampai ".$row->JadwalTanggalSelesai." Di ".$row->JadwalTempat; ?></option>
                                <?php } ?>
                            </select>
